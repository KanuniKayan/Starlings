// A follow up on deploy-commands.js
// https://discordjs.guide/legacy/slash-commands/deleting-commands
// Delete specific commands (by replacing commandId with the corresponding one)
// or delete all commands
...
(async () => {
    try {
        // Replace commandId with the id of the command you want to delete
